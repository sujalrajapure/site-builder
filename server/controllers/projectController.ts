...
export const makeRevision = async (req: Request, res: Response) => {
    ...
    try {
        ...
        // Enhance user prompt
        const promptEnhanceResponse = await gemini.model.generateContent(`
...
User's request: "${message}"`);
        ...
        const enhancedPrompt = promptEnhanceResponse.response.text();
        ...
        const codeGenerationResponse = await gemini.model.generateContent(`
...
Here is the current website code: "${currentProject.current_code}" The user wants this change: "${enhancedPrompt}"`);
        ...
        const code = codeGenerationResponse.response.text() || '';
