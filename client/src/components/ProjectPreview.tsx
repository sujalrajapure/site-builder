...
const ProjectPreview = forwardRef<ProjectPreviewRef, ProjectPreviewProps>(({project, isGenerating, generationProgress, device = 'desktop', showEditorPanel = true}, ref) => {
    ...
    <div className='relative h-full bg-gray-900 flex-1 rounded-xl overflow-hidden max-sm:ml-2'>
      {project.current_code ? (
        ...
        <LoaderSteps
          ...
          doneCount={generationProgress?.doneCount ?? 0}
          total={generationProgress?.total ?? 7}
          currentLabel={generationProgress?.currentLabel}
        />
      )}
    </div>
  )
